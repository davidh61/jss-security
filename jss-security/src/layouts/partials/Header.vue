<template>
  <header
    id="header"
    class="header bg-blue-950 flex flex-col md:flex-row md:justify-between items-center p-4 md:p-6"
    role="banner"
  >
    <g-link
      ...
      ><g-image src="~/assets/images/logo-white.png" width="100" />
    </g-link>
    ...
    <nav id="nav" class="nav hidden md:flex">
      ...
      >
        ...
        >
          <g-link
            :to="element.link"
            class="link font-bold text-white hover:text-yellow-400"
